...
<template v-if="om > 5">
  <div class="getkatten">
    ...
    <p>
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum sunt quos dolorem illo quibusdam aliquid
      praesentium
      nulla quasi, cupiditate ea minima perferendis? Temporibus soluta id, mollitia corrupti ipsum commodi fugiat!
    </p>
  </div>
</template>
